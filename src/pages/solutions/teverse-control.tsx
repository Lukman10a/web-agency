...
interface ReusableComponentProps {
  ...
  additionalImagePosition?: { bottom: number; left: number; top: number; right: number}; // Optional for position
}

const sections: ReusableComponentProps[] = [
  {
    image: "/assets/score.webp",
    additionalImage: "https://www.missioncloud.com/hubfs/2024_illustrations/Illustrations_Stars.svg", // Pass the animated image
    additionalImagePosition: { bottom: -20, left: -50, top:0, right:0 }, // Position for the animated image
    title: "Mission Cloud Score",
    description: "Improve your environment by measuring your alignment to best practices.",
  ...
  },
  {
    ...
    additionalImage: "https://www.missioncloud.com/hubfs/2024_illustrations/Illustrations_Tablet.svg", // Different animated image
  ...
  },
  {
    ...
    additionalImage: "https://www.missioncloud.com/hubfs/2024_illustrations/Illustrations_Portfolio.svg", // Another custom animated image
  ...
  },
  {
    ...
    additionalImage: "https://www.missioncloud.com/hubfs/2024_illustrations/Illustrations_Chat.svg",
    additionalImagePosition: { bottom: -20, left: 500, top: 30, right: 0 },
    title: "Supports ticketing and chats",
    description: "Access real-time support for technical troubleshooting with our CloudOps team.",
    buttonText: "Discover Now",
    showButton: false,
    reverse: false,
    starsAnimation: true,
...
const FeaturesSection = () => (
  <section className="font-medium text-left text-2xl space-y-6 py-10 mx-20">
    ...
    <p>
      For every insight, alert, or data point we visualize, you&apos;ll have access to an expert to help you understand what it
      means, why it matters, and how to act on it.
    </p>
  </section>
);

const FeatureList: React.FC<{ sections: ReusableComponentProps[] }> = ({ sections }) => (
  <div>
