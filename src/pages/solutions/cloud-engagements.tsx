  ...
  return (
    <div>
      ...
      <WhatIsTeverse
        ...
        mainDescription="Teverse Cloud Engagements - DevOps, powered by Teverse Control, enables both you and Mission to easily track and manage the work accomplished by your Mission Cloud DevOps team. Visualize the status of your initiatives in real time and use Mission Control’s observability and reporting tools to generate and prioritize a backlog of work while understanding its impact on your alignment to best practices."
