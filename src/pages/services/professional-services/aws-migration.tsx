...
const AWSIM = () => {
  ...
  return (
    <div>
      ...
      <WhatIsTeverse
        imageSrc={"/assets/cloud-provider.gif"}
        tag
        tagText="OVERVIEW"
      ...
      <section className="mx-auto max-w-7xl space-y-6 px-10 py-7 sm:w-full sm:px-5">
        ...
        <p className="text-xl font-normal sm:text-justify sm:text-lg">
      ...
      <section className="mx-auto max-w-7xl space-y-7 p-10 sm:w-full sm:px-5">
