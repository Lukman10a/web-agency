...
const CloudPlatformSection: React.FC = () => {
  ...
  return (
    <section className="bg-white py-16 px-4 sm:px-6 lg:px-8">
      <h2 className="text-4xl font-extrabold text-center text-gray-900 sm:text-4xl mb-4 leading-11">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-2 sm:grid-cols-1 gap-8 mt-16">
        ...
        <div className="text-left">
          <p className="text-2xl font-bold text-gray-900 mb-6">
            An unmatched set<br /> of building blocks
          </p>
          <p className="text-gray-600 text-lg mb-6">
            Ready made, battle-tested, and proven building blocks for<br /> rapid setup of well-architected infrastructure.
          </p>
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="flex flex-col space-y-6">
            {bulletPoints.slice(0, 3).map((point) => (
              <div key={point.id} className="border border-gray-400 p-6 rounded-lg hover:shadow-md transition-shadow duration-300">
                <div className="items-center mb-4 space-y-2">
                  <Image src="/assets/checkmark.png" width={20} height={20} alt="check mark" />
                  <h4 className="text-lg font-semibold text-gray-900">{point.text}</h4>
                </div>
              </div>
            ))}
          </div>
