...
const Benefits = () => {
  return (
    <section>
      <div className="mx-auto mb-16 w-[85%] max-w-[1200px]">
        ...
        <div className="grid w-full grid-cols-12 gap-4 sm:grid-cols-1">
          {items.map((item, index) => (
            <div
              key={index}
              className={`rounded-2xl border border-black bg-white p-8 font-sans shadow-sm sm:col-span-12 ${index === 0 ? "col-span-4" : ""} ${index === 1 ? "col-span-4" : ""} ${index === 2 ? "col-span-4" : ""} ${index === 3 ? "col-span-5" : ""} ${index === 4 ? "col-span-6" : ""} `}
            >
