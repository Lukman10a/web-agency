    ...
    <section className="mx-10 rounded-3xl bg-gradient-to-r from-gradient-100 to-gradient-200 py-16">
      <div className="relative mx-auto max-w-7xl px-14 lg:px-8 sm:px-6">
        ...
        <div className="mt-10 text-center">
          <button className="rounded-full bg-orange-600 px-6 py-3 font-semibold text-white shadow-md ring-1 ring-orange-700 transition duration-300 ease-in-out hover:bg-orange-500">
            See More &rarr;
          </button>
        </div>
      </div>
