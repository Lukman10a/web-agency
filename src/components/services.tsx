            ...
            <div className="max-w-6xl sm:w-full mx-auto bg-white rounded-lg shadow-md p-8 md:p-2 lg:p-14 space-y-4">
                ...
                <div className="grid gap-6 md:gap-8">
                    {serviceData.map((service, index) => (
                        <div key={index} className="p-6 sm:p-3 sm:text-sm bg-white ring-1 ring-neutral-500 rounded-lg shadow-sm flex sm:flex-wrap gap-32 sm:gap-6">
                            <div className="w-2/3 sm:w-full">
                                <h3 className="text-lg md:text-xl font-medium sm:text-sm text-gray-800 mb-3">{service.title}</h3>
