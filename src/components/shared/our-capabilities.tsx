   ...
   <div className="w-[90%] max-w-[1200px] mx-auto py-4">
      ...
      <div className=" mb-32 grid grid-cols-3 2md:grid-cols-2 sm:grid-cols-1 w-full max-w-[1200px]  justify-center gap-4 2md:items-center md:mb-16 md:flex-col">
        {detailsData.map((detail, index) => (
            <div className="w-full max-w-[600px] rounded-xl p-6 border border-black sm:mx-auto">
                <Image
          src={detail.icon}
        alt="image"
          className="w-10 mb-4"
          ...
          height={500}
        />
      <h4 className="mb-[.6em] font-sans text-xl font-medium">{detail.title}</h4>
      
      <p className="font-sans text-sm text-[#808080]">{detail.description}</p>
